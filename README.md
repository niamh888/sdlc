...
- **Quiz page** — two 15-question assessments (Introductory and Advanced), selected automatically from the training level set on the Learn page; randomised order, 30-second timer per question, immediate feedback, and a pass/fail results screen; 80% pass mark earns a downloadable certificate that reflects the training level completed
...
| `quiz.js` | Quiz engine — two question sets (introductory/advanced), shuffle, timer, scoring, results, certificate |
